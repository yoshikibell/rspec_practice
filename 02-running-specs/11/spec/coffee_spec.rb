...
RSpec.describe 'A cup of coffee' do
  ...
  context 'with milk' do
    ...
    it 'is light in color' do
      pending 'Color is not implemented yet'
      # test will mark as fail now that the code below is implemented. use skip to keep pending status, or xit to REALLY skip
